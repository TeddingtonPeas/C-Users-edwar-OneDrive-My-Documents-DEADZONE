...
::docker-compose -f docker-compose.yml run --rm freqtrade hyperopt -s deadzone --spaces  buy --hyperopt-loss SorinoHyperOptLoss -c user_data/config.json -e 4000 --timerange=20220601-20220825
::docker-compose -f docker-compose.yml run --rm freqtrade hyperopt -s deadzone --spaces  buy --hyperopt-loss OnlyProfitHyperOptLoss -c user_data/config.json -e 100 --timerange=20220601-20220825 -j 8
